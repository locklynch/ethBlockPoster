    ...
    <>
      <div id='instructions' className='instructions'>
        ...
        <ol>
          ...
          <li>The lines between the blockchain, block, and notes are a bit wonky on load, but scroll or resize and they pop into place!</li>
          ...
          <li>I've been playing around with block 18181818, but anything after The Merge will do (15537394 and after)</li>
